...
export default class Cultures implements Table {
  // eslint-disable-next-line class-methods-use-this
  static async load(): Promise<any[]> {
    return window.api
      .invoke('fetch-all-table-data', SELECTALL.CULTURES)
      .then((res: any) => {
        return res;
      })
      .catch((err: Error) => err);
